...
- Nav: Shellui **wordmark** (`#logo-shellui`, 1.25rem height, same as shellui.com); footer brand: Shellui **mark** (`#logo-shellui-mark`, ~34px). No domain suffix beside either logo.
